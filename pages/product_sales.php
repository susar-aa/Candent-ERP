...
if ($search_query !== '') {
    $outer_where .= " AND (p.name LIKE ? OR p.sku LIKE ?)";
    $outer_params[] = "%$search_query%";
    $outer_params[] = "%$search_query%";
}
if ($category_filter !== '') {
    $outer_where .= " AND p.category_id = ?";
    $outer_params[] = $category_filter;
}
        ...
        <table class="ios-table">
            <thead>
                <tr class="table-ios-header">
                    ...
                    <th class="text-center" style="width: 8%;">Orders</th>
                    <th class="text-center" style="width: 17%;">Qty (Gross / Ret / Net)</th>
                    <th class="text-end" style="width: 12%;">Gross Revenue</th>
                    <th class="text-end" style="width: 12%; color: #CC2200 !important;">Discounts</th>
                    <th class="text-end" style="width: 12%; color: #CC2200 !important;">Returned Value</th>
                    <th class="text-end pe-4" style="width: 14%; color: #1A9A3A !important;">Net Revenue</th>
                </tr>
            </thead>
            <tbody>
